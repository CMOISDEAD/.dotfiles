            ...
            Widget.Box({
                ...
                children: [
                    ...
                    Widget.Button({
                        ...
                        on_clicked: async () => {
                            const value = await Utils.execAsync("hyprshade current");
                            night_light.setValue(value.trim() !== "blue-light-filter");
                            Utils.execAsync("hyprshade toggle blue-light-filter");
                        },
                        setup: (self) => {
